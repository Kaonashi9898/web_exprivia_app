...
import it.exprivia.prenotazioni.dto.ApiErrorResponse;
import it.exprivia.prenotazioni.security.JwtAuthFilter;
import it.exprivia.prenotazioni.security.JwtUtils;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/prenotazioni/mie/notifiche-annullamento").hasAnyRole("USER", "BUILDING_MANAGER", "RECEPTION", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/prenotazioni/risorse").hasAnyRole("USER", "BUILDING_MANAGER", "RECEPTION", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/prenotazioni").hasAnyRole("RECEPTION", "BUILDING_MANAGER", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/prenotazioni/postazione/**").hasAnyRole("BUILDING_MANAGER", "RECEPTION", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/prenotazioni/meeting-room/**").hasAnyRole("BUILDING_MANAGER", "RECEPTION", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/prenotazioni/**").hasAnyRole("USER", "BUILDING_MANAGER", "RECEPTION", "ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/prenotazioni/**").hasAnyRole("USER", "BUILDING_MANAGER", "RECEPTION", "ADMIN")
